...
public class ClockController {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<Clock> getProductById(@PathVariable("id") int id) {
    ...
    @PutMapping("/edit/{id}")
    public ResponseEntity<Clock> editProduct(@RequestBody Clock product, @PathVariable("id") int id){
    ...
    @GetMapping("/search")
    public ResponseEntity<List<Clock>> searchClocks(@RequestParam String query) {
        List<Clock> clocks = clockService.searchProducts(query);
